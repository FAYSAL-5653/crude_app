...
class crude
{
  ...
  public function __construct()
  {
    ...
    echo $conReport = (!$this->con) ? " Sorry !!! connection is not created" : " yeahoo!!!!!connection is created successfully ";
  }
  ...
  public  function updateData($id)
  {
    ...
    $get_updet_Data = mysqli_query($this->con, $qeary);
    if ($get_updet_Data) {
      $singleData = mysqli_fetch_assoc($get_updet_Data);
      return $singleData;
    }
  }
  ...
  public function updateInfo($data)
  {
    ...
    $get_updetInfoData = mysqli_query($this->con, $qeary);
    if ($get_updetInfoData) {
